...
namespace Breeze\Detection;

use BadMethodCallException;
use Breeze\Detection\Cache\Cache;
use Breeze\Detection\Cache\CacheException;
use Breeze\Detection\Cache\CacheInvalidArgumentException;
use Breeze\Detection\Exception\MobileDetectException;
use Breeze\Detection\Exception\MobileDetectExceptionCode;
use Breeze\Psr\SimpleCache\CacheInterface;
use Breeze\Psr\SimpleCache\InvalidArgumentException as PsrInvalidArgumentException;
/**
...
class MobileDetect
{
    ...
    protected static array $browsers = [
        ...
        //'Midori'          => 'midori',
        //'Tizen'           => 'Tizen',
        'WeChat' => 'Breeze\bMicroMessenger\b',
    ...
    public function autoInitKnownHttpHeaders(): void
    {
        ...
        $knownHttpHeaders = array_merge(array_values(static::$knownUserAgentHttpHeaders), array_keys(static::$knownMobilePositiveHeaders), array_values(static::$knownCloudFrontHeaders));
    ...
    public function setHttpHeaders(array $httpHeaders = []): void
    {
        ...
        if ($this->hasHttpHeader(static::$knownCloudFrontHeaders[0]) || $this->hasHttpHeader(static::$knownCloudFrontHeaders[1])) {
    ...
    public function getRules(): array
    {
        ...
        if (!isset($rulesByClass[$class])) {
            $rulesByClass[$class] = array_merge(static::$browsers, static::$operatingSystems, static::$phoneDevices, static::$tabletDevices);
        }
    ...
    public function isMobile(): bool
    {
        ...
        try {
            ...
            if ($this->getUserAgent() === static::$cloudFrontUA && $this->getHttpHeader('HTTP_CLOUDFRONT_IS_MOBILE_VIEWER') === 'true') {
    ...
    public function isTablet(): bool
    {
        ...
        try {
            ...
            // Special case: Amazon CloudFront mobile viewer
            if ($this->getUserAgent() === static::$cloudFrontUA && $this->getHttpHeader('HTTP_CLOUDFRONT_IS_TABLET_VIEWER') === 'true') {
                $this->cache->set($cacheKey, \true, $this->config['cacheTtl']);
                return \true;
            }
