...
<div class="dgwt-wcas-preview js-dgwt-wcas-preview">
	...
	<div class="js-dgwt-wcas-preview-inner dgwt-wcas-preview-inner">
		<div class="js-dgwt-wcas-preview-head dgwt-wcas-preview-head">
			...
			<span
				class="dgwt-wcas-preview-subheader dgwt-wcas-preview-subheader__sb"><?php _e( 'Search bar', 'ajax-search-for-woocommerce' ); ?></span>
			<span
				class="dgwt-wcas-preview-subheader dgwt-wcas-preview-subheader__ac"><?php _e( 'Autocomplete', 'ajax-search-for-woocommerce' ); ?></span>
		</div>
		...
		<div class="js-dgwt-wcas-preview-source dgwt-wcas-preview-source">
			...
			<div
				class="js-dgwt-wcas-search-wrapp js-dgwt-wcas-preview-bar-example dgwt-wcas-search-wrapp <?php echo Helpers::searchWrappClasses(); ?>"
				...
				<form class="dgwt-wcas-search-form" role="search" action="" method="get">
					<div class="dgwt-wcas-sf-wrapp">
						...
						<label
							class="screen-reader-text"><?php _e( 'Products search', 'ajax-search-for-woocommerce' ); ?></label>
			...
			<div
				class="js-dgwt-wcas-search-wrapp dgwt-wcas-layout-icon-open js-dgwt-wcas-preview-icon-example dgwt-wcas-search-wrapp dgwt-wcas-hidden <?php echo Helpers::searchWrappClasses(); ?>"
				data-wcas-context="75c3">
				<a
					href="#" class="dgwt-wcas-search-icon js-dgwt-wcas-search-icon-handler"><?php echo Helpers::getMagnifierIco( 'dgwt-wcas-ico-magnifier-handler' ); ?>
				</a>
			...
			<div class="dgwt-wcas-autocomplete">
				...
				<div
					...
					foreach ( $postTypes as $postType ) {
						...
						?>
						<div
							class="dgwt-wcas-suggestion dgwt-wcas-suggestion-headline-cpt dgwt-wcas-suggestion-headline-<?php echo esc_attr( $postType ); ?> dgwt-wcas-suggestion-headline">
						<span class="dgwt-wcas-st">
						...
						<div
							class="dgwt-wcas-suggestion dgwt-wcas-suggestion-cpt dgwt-wcas-suggestion-<?php echo esc_attr( $postType ); ?> js-dgwt-wcas-suggestion-<?php echo esc_attr( $postType ); ?>">
						<span class="dgwt-wcas-si">
						<img src="<?php echo DGWT_WCAS_URL; ?>assets/img/product-preview.png">
						</span>
							<span class="dgwt-wcas-st">
					...
					<span class="js-dgwt-wcas-si dgwt-wcas-si">
						...
						<span class="dgwt-wcas-st">
							<span
								class="dgwt-wcas-st-title"><?php _e( 'Sample product <strong>name</strong>', 'ajax-search-for-woocommerce' ); ?></span>
							<span
								class="dgwt-wcas-sku js-dgwt-wcas-sku">(<?php echo Helpers::getLabel( 'sku_label' ); ?> 0001)</span>
							<span
								class="dgwt-wcas-sd js-dgwt-wcas-sd"><?php _e( 'Lorem <strong>ipsum</strong> dolor sit amet, consectetur adipiscing elit. Quisque gravida lacus nec diam porttitor pharetra. Nulla facilisi. Proin pharetra imperdiet neque, non varius.', 'ajax-search-for-woocommerce' ); ?></span>
						</span>
					...
					<div
						...
						<span class="dgwt-wcas-st-more"><span
								class="js-dgwt-wcas-st-more-label"><?php echo esc_html( $labelSeeAll ); ?></span> (73)</span>
					</div>
						...
						<div class="dgwt-wcas-product-details">
							...
							<div class="dgwt-wcas-details-space">
								...
								<div class="dgwt-wcas-pd-desc">
									<?php
									_e(
										'Lorem <strong>ipsum</strong> dolor sit amet, consectetur adipiscing elit. Quisque gravida lacus nec diam porttitor pharetra. Nulla facilisi. Proin pharetra imperdiet neque, non varius.',
