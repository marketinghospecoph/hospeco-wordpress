...
class ProductVariation extends Product {
	...
	public function canUserSee( bool $checkStockStatus = true, string $context = '' ): bool {
		...
		if ( current_user_can( 'edit_post', $parentId ) || current_user_can( 'edit_post', $variationId ) ) {
			return (bool) apply_filters( 'dgwt/wcas/product_variation/can_show_in_details_panel', true, $this, $parent );
		}
		...
		return (bool) apply_filters( 'dgwt/wcas/product_variation/can_show_in_details_panel', $canShow, $this, $parent );
	}
