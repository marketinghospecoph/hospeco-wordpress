				...
				array(
					'quantity-table' => apply_filters( 'wccs_settings_promotion_quantity_table_section',
						array(
							...
							'quantity_table_enable_tier_selection' => array(
									'id'      => 'quantity_table_enable_tier_selection',
									'name'    => __( 'Enable Tier Selection', 'easy-woocommerce-discounts' ),
									'desc'    => __( 'Show radio buttons in the pricing table. Clicking a row or radio button will automatically set the product quantity to that tier.', 'easy-woocommerce-discounts' ),
									'type'    => 'select',
									'std'     => 'yes',
									'options' => array(
										'yes' => __( 'Yes', 'easy-woocommerce-discounts' ),
							...
							'quantity_table_theme_preset' => array(
								'id'      => 'quantity_table_theme_preset',
								'name'    => __( 'Table Theme Preset', 'easy-woocommerce-discounts' ),
								'desc'    => __( 'Select a pre-defined cute color theme. Selecting a theme will update the custom colors below.', 'easy-woocommerce-discounts' ),
								'type'    => 'select',
								'std'     => 'default',
								'options' => array(
									'default'         => __( 'Default Periwinkle', 'easy-woocommerce-discounts' ),
									'sakura'          => __( 'Sakura Pink (Cute Pastel)', 'easy-woocommerce-discounts' ),
									'minty'           => __( 'Mint Fresh (Cute Green)', 'easy-woocommerce-discounts' ),
									'lavender'        => __( 'Lavender Dreams (Cute Purple)', 'easy-woocommerce-discounts' ),
									'ocean'           => __( 'Ocean Breeze (Cute Blue)', 'easy-woocommerce-discounts' ),
									'sunset'          => __( 'Sunset Glow (Cute Warm)', 'easy-woocommerce-discounts' ),
									'banana'          => __( 'Banana Milk (Cute Yellow)', 'easy-woocommerce-discounts' ),
									'peach'           => __( 'Peach Puff (Cute Coral)', 'easy-woocommerce-discounts' ),
									'marshmallow'     => __( 'Marshmallow (Cute Soft)', 'easy-woocommerce-discounts' ),
									'eucalyptus'      => __( 'Eucalyptus (Calming Sage)', 'easy-woocommerce-discounts' ),
									'blueberry'       => __( 'Blueberry Tart (Rich Indigo)', 'easy-woocommerce-discounts' ),
									'coffee'          => __( 'Coffee Cream (Warm Latte)', 'easy-woocommerce-discounts' ),
									'retro'           => __( 'Retro Coral (Vibrant Cream)', 'easy-woocommerce-discounts' ),
									'matcha'          => __( 'Matcha Latte (Creamy Green)', 'easy-woocommerce-discounts' ),
									'night_dark'      => __( 'Nordic Slate (Dark Mode)', 'easy-woocommerce-discounts' ),
									'night_purple'    => __( 'Midnight Purple (Night Mode)', 'easy-woocommerce-discounts' ),
									'night_cyber'     => __( 'Cyberpunk Neon (Night Mode)', 'easy-woocommerce-discounts' ),
									'night_emerald'   => __( 'Neon Emerald (Night Mode)', 'easy-woocommerce-discounts' ),
									'night_teal'      => __( 'Teal Forest (Night Mode)', 'easy-woocommerce-discounts' ),
									'night_cocoa'     => __( 'Dark Cocoa (Night Mode)', 'easy-woocommerce-discounts' ),
									'custom'          => __( 'Custom Colors (Manual)', 'easy-woocommerce-discounts' ),
								),
							),
							'quantity_table_header_bg' => array(
								'id'   => 'quantity_table_header_bg',
								'name' => __( 'Table Header Background Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Background color of the table header cells and label columns.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#6c7ae0',
							),
							'quantity_table_header_text' => array(
								'id'   => 'quantity_table_header_text',
								'name' => __( 'Table Header Text Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Text color of the table header cells.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#ffffff',
							),
							'quantity_table_body_bg' => array(
								'id'   => 'quantity_table_body_bg',
								'name' => __( 'Table Body Background Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Background color of odd table body rows.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#ffffff',
							),
							'quantity_table_body_text' => array(
								'id'   => 'quantity_table_body_text',
								'name' => __( 'Table Body Text Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Text color of the table body cells.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#808080',
							),
							'quantity_table_stripe_bg' => array(
								'id'   => 'quantity_table_stripe_bg',
								'name' => __( 'Table Alternating Row Background Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Background color of even table body rows.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#f8f6ff',
							),
							'quantity_table_hover_bg' => array(
								'id'   => 'quantity_table_hover_bg',
								'name' => __( 'Table Row Hover Background Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Background color of table body rows on mouse hover.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#f1f3ff',
							),
							'quantity_table_theme_color' => array(
								'id'   => 'quantity_table_theme_color',
								'name' => __( 'Table Accent Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Custom accent color for active tier highlights and switcher buttons.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#6c7ae0',
							),
							'quantity_table_theme_bg' => array(
								'id'   => 'quantity_table_theme_bg',
								'name' => __( 'Table Active Tier Background Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Background color for the active highlighted quantity tier.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#f8f6ff',
							),
							'quantity_table_theme_text' => array(
								'id'   => 'quantity_table_theme_text',
								'name' => __( 'Table Active Tier Text Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Text color for the active highlighted quantity tier.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#6c7ae0',
							),
							'quantity_table_theme_border' => array(
								'id'   => 'quantity_table_theme_border',
								'name' => __( 'Table Active Tier Border Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Border color for the active highlighted quantity tier.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#c3caf7',
							),
						)
					...
					'discount-page' => apply_filters( 'wccs_settings_promotion_discount_page_section',
						array(
							...
							'discount_page_box_bg_color' => array(
								'id'   => 'discount_page_box_bg_color',
								'name' => __( 'Background Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Message box background color.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#f8faff',
							),
							'discount_page_box_border_color' => array(
								'id'   => 'discount_page_box_border_color',
								'name' => __( 'Border Accent Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Message box left accent border color.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#6c7ae0',
							),
							'discount_page_box_text_color' => array(
								'id'   => 'discount_page_box_text_color',
								'name' => __( 'Text Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Message box text color.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#1e293b',
							),
							'discount_page_box_icon_color' => array(
								'id'   => 'discount_page_box_icon_color',
								'name' => __( 'Icon Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Message box icon color.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#6c7ae0',
							),
							'discount_page_box_icon_bg_color' => array(
								'id'   => 'discount_page_box_icon_bg_color',
								'name' => __( 'Icon Background Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Message box icon circle background color.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#eef1fc',
							),
							'discount_page_box_link_bg_color' => array(
								'id'   => 'discount_page_box_link_bg_color',
								'name' => __( 'Button Background Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Discount page link button background color.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#6c7ae0',
							),
							'discount_page_box_link_color' => array(
								'id'   => 'discount_page_box_link_color',
								'name' => __( 'Button Text Color', 'easy-woocommerce-discounts' ),
								'desc' => __( 'Discount page link button text color.', 'easy-woocommerce-discounts' ),
								'type' => 'color',
								'std'  => '#ffffff',
							),
						)
