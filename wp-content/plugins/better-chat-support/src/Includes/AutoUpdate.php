...
class AutoUpdate {
	...
	public function show_changelog() {
		...
		if ( ! current_user_can( 'update_plugins' ) ) {
			wp_die( esc_html__( 'You do not have permission to install plugin updates', 'better-chat-support' ), esc_html__( 'Error', 'better-chat-support' ), array( 'response' => 403 ) );
		}
