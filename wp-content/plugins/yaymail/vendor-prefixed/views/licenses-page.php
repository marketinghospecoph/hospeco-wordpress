...
if (!empty($is_network)) {
    ?>
        <div class="yaycommerce-license__network-notice">
            <span>
                <strong><?php 
    \esc_html_e('Network Admin:', 'yaycommerce');
    ?> </strong>
                <?php 
    \esc_html_e('License keys are managed per site. Activate each plugin license from the individual site\'s dashboard.', 'yaycommerce');
    ?>
            </span>
        </div>
        <?php 
