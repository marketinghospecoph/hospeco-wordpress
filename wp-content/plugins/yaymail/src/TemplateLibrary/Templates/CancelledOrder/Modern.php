...
/**
 * Modern template for Admin Cancelled Order email.
 */
class Modern extends BaseTemplate {
    ...
    public function __construct() {
        parent::__construct();
        $this->id          = 'cancelled_order_modern';
        ...
        $this->elements    = [
            ...
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span style="font-size: 16px">We’re getting in touch to let you know that order #[yaymail_order_number is_plain="true"] from [yaymail_billing_first_name] [yaymail_billing_last_name] has been cancelled.</span></p>',
                ]
            ),
            ...
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p style="text-align: center"><span style="font-size: 16px">Thanks for reading.</span></p>',
                ]
            ),
