...
namespace YayMail\TemplateLibrary\Templates\CancelledOrder;
...
/**
 * Classic template for Admin Cancelled Order email.
 */
class Classic extends BaseTemplate {
    ...
    public function __construct() {
        parent::__construct();
        $this->id          = 'cancelled_order_classic';
        ...
        $this->elements    = [
            Logo::get_object_data(
                [
                    ...
                    'src'                        => 'http://localhost:8080/wp-content/plugins/yaymail/assets/images/woocommerce-logo.png',
                    'align'                      => 'center',
                    'width'                      => '172',
                    'url'                        => '#',
                    'alt'                        => '',
            ...
            Heading::get_object_data(
                [
                    ...
                    'text_color'                 => '#ffffff',
                    'rich_text'                  => '<h1 style="font-size:30px;font-weight:300;line-height:normal;margin:0px;color:inherit">Order Cancelled:  #[yaymail_order_number is_plain="true"]</h1>',
                ]
            ),
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span>Notification to let you know &mdash; order #[yaymail_order_number is_plain="true"] belonging to [yaymail_billing_first_name] [yaymail_billing_last_name] has been cancelled:</span></p>',
                ]
            ),
            ...
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span>Thanks for reading.</span></p>',
                ]
            ),
