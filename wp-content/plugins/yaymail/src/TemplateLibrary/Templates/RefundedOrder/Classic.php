...
/**
 * Classic template for Refunded Order email.
 */
class Classic extends BaseTemplate {
    ...
    public function __construct() {
        parent::__construct();
        $this->id          = 'refunded_order_classic';
        ...
        $this->elements    = [
            ...
            Heading::get_object_data(
                [
                    ...
                    'text_color'                 => '#ffffff',
                    'rich_text'                  => '<h1 style="font-size:30px;font-weight:300;line-height:normal;margin:0px;color:inherit">[yaymail_get_heading]</h1>',
                ]
            ),
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span>Hi [yaymail_billing_first_name],<br /></span></p><p><span>Your order on [yaymail_site_name] has been [yaymail_refund_type]. There are more details below for your reference:</span></p>',
                ]
            ),
            ...
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span>We hope to see you again soon.</span></p>',
                ]
            ),
