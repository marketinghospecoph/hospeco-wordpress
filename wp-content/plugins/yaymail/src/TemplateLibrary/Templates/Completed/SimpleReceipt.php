...
/**
 * Simple Receipt template for Completed Order email.
 */
class SimpleReceipt extends BaseTemplate {
    use SingletonTrait;
    ...
    public function __construct() {
        ...
        $this->name              = 'Simple Receipt';
        $this->description       = 'A clean, distraction-free confirmation.';
        $this->categories        = [ 'Minimal Collection' ];
