...
namespace YayMail\TemplateLibrary\Templates\CustomerFailedOrder;
...
/**
 * Modern template for Failed Order (Customer) email.
 */
class Modern extends BaseTemplate {
    ...
    public function __construct() {
        parent::__construct();
        $this->id          = 'customer_failed_order_modern';
        ...
        $this->elements    = [
            ...
            Heading::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#3c3c3c',
                    'rich_text'                  => '<p><span style="font-size: 30px"><strong>Sorry, your order was unsuccessful</strong></span></p>',
                ]
            ),
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span style="font-size: 16px">Hi [yaymail_billing_first_name]</span></p><br/><p><span style="font-size: 16px">Unfortunately, we couldn\'t complete your order due to an issue with your payment method.</span></p><br/><p><span style="font-size: 16px">If you\'d like to continue with your purchase, please return to [yaymail_site_name] and try a different method of payment.</span></p><br/><p><span style="font-size: 16px">Your order details are as follows:</span></p>',
                ]
            ),
