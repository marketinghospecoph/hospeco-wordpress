...
/**
 * Classic template for Failed Order (Customer) email.
 */
class Classic extends BaseTemplate {
    ...
    public function __construct() {
        parent::__construct();
        $this->id          = 'customer_failed_order_classic';
        ...
        $this->elements    = [
            ...
            Heading::get_object_data(
                [
                    ...
                    'text_color'                 => '#ffffff',
                    'rich_text'                  => '<h1 style="font-size:30px;font-weight:300;line-height:normal;margin:0px;color:inherit">Sorry, your order was unsuccessful</h1>',
                ]
            ),
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span>Hi [yaymail_billing_first_name]</span></p><br /><p><span>Unfortunately, we couldn\'t complete your order due to an issue with your payment method.</span></p><br /><p><span>If you\'d like to continue with your purchase, please return to [yaymail_site_name] and try a different method of payment.</span></p><br /><p><span>Your order details are as follows:</span></p>',
                ]
            ),
