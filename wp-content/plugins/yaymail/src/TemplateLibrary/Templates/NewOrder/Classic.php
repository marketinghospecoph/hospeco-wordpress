...
/**
 * Classic template for New Order email.
 */
        ...
        $this->elements    = [
            ...
            Heading::get_object_data(
                [
                    ...
                    'text_color'                 => '#ffffff',
                    'rich_text'                  => '<h1 style="font-size:30px;font-weight:300;line-height:normal;margin:0px;color:inherit">New order: #[yaymail_order_number is_plain="true"]</h1>',
                ]
            ),
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span>You’ve received the following order from [yaymail_billing_first_name] [yaymail_billing_last_name]:</span></p>',
                ]
            ),
            ...
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span>Congratulations on the sale.</span></p>',
                ]
            ),
