...
/**
 * Modern template for Processing Order email.
 */
class Modern extends BaseTemplate {
    ...
    public function __construct() {
        parent::__construct();
        $this->id          = 'processing_order_modern';
        ...
        $this->elements    = [
            ...
            Heading::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#3c3c3c',
                    'rich_text'                  => '<h1 style="font-size: 32px;letter-spacing: -1px;line-height: 38.4px;margin: 0px">Thank you for your order</h1>',
                ]
            ),
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span style="font-size: 16px">Hi </span><span style="font-size: 16px">[yaymail_billing_first_name],</span></p><br/><p style="font-size: 16px">Just to let you know — we’ve received your order, and it is now being processed.</p><br/><p style="font-size: 16px">Here\'s a reminder of what you\'ve ordered:</p>',
                ]
            ),
