...
namespace YayMail\TemplateLibrary\Templates\FailedOrder;
...
/**
 * Modern template for Failed Order (Admin) email.
 */
        ...
        $this->elements    = [
            ...
            Heading::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#3c3c3c',
                    'rich_text'                  => '<p><span style="font-size: 30px"><strong>Order failed: #[yaymail_order_number is_plain="true"]</strong></span></p>',
                ]
            ),
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span style="font-size: 16px">Unfortunately, the payment for order </span><span style="font-size: 16px">#[yaymail_order_number is_plain="true"] </span><span style="font-size: 16px">from [yaymail_billing_first_name] [yaymail_billing_last_name] has failed. The order was as follows:</span></p>',
                ]
            ),
            ...
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p style="text-align: center"><span style="font-size: 16px">We hope they’ll be back soon! Read more about <a href="https://woocommerce.com/document/managing-orders/">troubleshooting failed payments</a>.</span></p>',
                ]
            ),
