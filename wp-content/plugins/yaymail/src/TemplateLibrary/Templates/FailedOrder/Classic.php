...
/**
 * Classic template for Failed Order (Admin) email.
 */
        ...
        $this->elements    = [
            ...
            Heading::get_object_data(
                [
                    ...
                    'text_color'                 => '#ffffff',
                    'rich_text'                  => '<h1 style="font-size:30px;font-weight:300;line-height:normal;margin:0px;color:inherit">Order Failed: #[yaymail_order_number is_plain="true"]</h1>',
                ]
            ),
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span>Payment for order #[yaymail_order_number is_plain="true"] from [yaymail_billing_first_name] [yaymail_billing_last_name] has failed. The order was as follows:</span></p>',
                ]
            ),
            ...
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span>Hopefully they\'ll be back. Read more about <a style="color: #873EFF" href="https://docs.woocommerce.com/document/managing-orders/">troubleshooting failed payments</a>.</span></p>',
                ]
            ),
