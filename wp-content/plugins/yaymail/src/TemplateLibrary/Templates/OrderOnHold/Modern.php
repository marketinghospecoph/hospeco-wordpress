...
/**
 * Modern template for Order On Hold email.
 */
        ...
        $this->elements    = [
            ...
            Heading::get_object_data(
                [
                    ...
                    'font_family'      => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'       => '#3c3c3c',
                    'rich_text'        => '<h1 style="font-size: 32px;letter-spacing: -1px;line-height: 38.4px;margin: 0px">Details for order <strong><span style="font-size: 30px">#[yaymail_order_number is_plain="true"]</span></strong></h1>',
                ]
            ),
            Text::get_object_data(
                [
            ...
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span style="font-size: 16px">Here are the details of your order placed on [yaymail_order_date]:</span></p>',
                ]
            ),
