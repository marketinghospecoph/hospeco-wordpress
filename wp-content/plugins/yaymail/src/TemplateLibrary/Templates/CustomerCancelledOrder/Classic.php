...
/**
 * Classic template for Cancelled Order (Customer) email.
 */
class Classic extends BaseTemplate {
    ...
    public function __construct() {
        parent::__construct();
        $this->id          = 'customer_cancelled_order_classic';
        ...
        $this->elements    = [
            ...
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span>We’re getting in touch to let you know that your order #[yaymail_order_number is_plain="true"] has been cancelled.</span></p>',
                ]
            ),
