...
namespace YayMail\TemplateLibrary\Templates\CustomerCancelledOrder;
...
/**
 * Modern template for Cancelled Order (Customer) email.
 */
class Modern extends BaseTemplate {
    ...
    public function __construct() {
        parent::__construct();
        $this->id          = 'customer_cancelled_order_modern';
        $this->email_type  = 'customer_cancelled_order';
        $this->name        = 'Modern';
        ...
        $this->elements    = [
            ...
            Heading::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#3c3c3c',
                    'rich_text'                  => '<p><span style="font-size: 30px"><strong>Order Cancelled: #[yaymail_order_number is_plain="true"]</strong></span></p>',
                ]
            ),
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p><span style="font-size: 16px">We’re getting in touch to let you know that your order #[yaymail_order_number is_plain="true"] has been cancelled.</span></p>',
                ]
            ),
            ...
            Text::get_object_data(
                [
                    ...
                    'font_family'                => 'Helvetica,Roboto,Arial,sans-serif',
                    'text_color'                 => '#636363',
                    'rich_text'                  => '<p style="text-align: center"><span style="font-size: 16px">We hope to see you again soon.</span></p>',
                ]
            ),
