 ...
 */
class FeaturedPosts extends BaseElement {

    use SingletonTrait;

    protected static $type = 'featured_posts';

    public $available_email_ids = [];

    public static function get_data( $attributes = [] ) {
        self::$icon = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
  <path d="M4,2.5h12c.83,0,1.5.67,1.5,1.5v12c0,.83-.67,1.5-1.5,1.5H4c-.83,0-1.5-.67-1.5-1.5V4c0-.83.67-1.5,1.5-1.5ZM5,5v10h10V5H5ZM7,7h6v1.5H7V7Zm0,3h6v1.5H7v-1.5Zm0,3h4v1.5H7v-1.5Z"/>
</svg>';
        ...
        return [
            'id'              => uniqid(),
            'type'            => self::$type,
            'name'            => __( 'Featured Posts', 'yaymail' ),
            'icon'            => self::$icon,
            'group'           => 'block',
            'tags'            => [ 'wordpress' ],
            'available'       => false,
            ...
            'data'            => [
                ...
                'showing_items'            => [
                    ...
                    'default_value' => isset( $attributes['showing_items'] ) ? $attributes['showing_items'] : [ 'top_content', 'post_image', 'post_title', 'post_excerpt', 'post_date', 'post_author', 'button' ],
                    'type'          => 'content',
                    'options'       => [
                        [
                        ...
                        [
                            'label' => __( 'Post image', 'yaymail' ),
                            'value' => 'post_image',
                        ],
                        [
                            'label' => __( 'Post title', 'yaymail' ),
                            'value' => 'post_title',
                        ],
                        [
                            'label' => __( 'Post excerpt', 'yaymail' ),
                            'value' => 'post_excerpt',
                        ],
                        [
                            'label' => __( 'Post date', 'yaymail' ),
                            'value' => 'post_date',
                        ],
                        [
                            'label' => __( 'Post author', 'yaymail' ),
                            'value' => 'post_author',
                        ],
                        [
                ...
                'top_content'              => [
                    ...
                    'default_value' => isset( $attributes['top_content'] ) ? $attributes['top_content'] : '<p style="text-align: center;"><span style="font-size: 18px;"><strong>FEATURED POSTS</strong></span></p>
                ...
                'button_label'             => [
                    'value_path'    => 'button_label',
                    'component'     => 'TextInput',
                    'title'         => __( 'Button text', 'yaymail' ),
                    'default_value' => isset( $attributes['button_label'] ) ? $attributes['button_label'] : __( 'READ MORE', 'yaymail' ),
                    'type'          => 'content',
                    'conditions'    => $button_conditions,
                ],
                ...
                'button_text_color'        => [
                    ...
                    'default_value' => isset( $attributes['button_text_color'] ) ? $attributes['button_text_color'] : '#ffffff',
                    'type'          => 'style',
                    'conditions'    => $button_conditions,
                ],
                'posts_breaker'            => [
                ...
                'posts_group_definition'   => [
                    'component'   => 'GroupDefinition',
                    'title'       => __( 'Posts', 'yaymail' ),
                    'description' => __( 'Handle posts settings', 'yaymail' ),
                ],
                'posts_per_row'            => [
                    'value_path'    => 'posts_per_row',
                    'component'     => 'NumberInput',
                    'title'         => __( 'Posts per row', 'yaymail' ),
                    'default_value' => isset( $attributes['posts_per_row'] ) ? $attributes['posts_per_row'] : '2',
                    'min'           => 1,
                    'max'           => 3,
                    'type'          => 'content',
                ],
                'post_type'                => [
                    'value_path'    => 'post_type',
                    'component'     => 'Selector',
                    'title'         => __( 'Post type', 'yaymail' ),
                    'default_value' => isset( $attributes['post_type'] ) ? $attributes['post_type'] : 'newest',
                    'type'          => 'content',
                    'options'       => [
                        [
                        ...
                        [
                            'label' => __( 'Post selections', 'yaymail' ),
                            'value' => 'post_selections',
                        ],
                    ],
                ],
                'categories'               => [
                ...
                'posts'                    => [
                    ...
                    'component'     => 'EntitiesSelector',
                    'title'         => __( 'Posts', 'yaymail' ),
                    'default_value' => isset( $attributes['posts'] ) ? $attributes['posts'] : [],
                    'type'          => 'content',
                    'entity_type'   => 'posts',
                    'conditions'    => [
                        [
                ...
                'sorted_by'                => [
                    ...
                    'options'       => [
                        ...
                        [
                            'label' => __( 'Date ascending', 'yaymail' ),
                            'value' => 'date_ascending',
                        ],
                        [
                            'label' => __( 'Date descending', 'yaymail' ),
                ...
                'number_of_posts'          => [
                    'value_path'    => 'number_of_posts',
                    'component'     => 'NumberInput',
                    'title'         => __( 'Number of featured posts', 'yaymail' ),
                    'default_value' => isset( $attributes['number_of_posts'] ) ? $attributes['number_of_posts'] : '4',
                    'type'          => 'content',
                    'min'           => 1,
                    'max'           => 20,
                    'is_debounce'   => true,
